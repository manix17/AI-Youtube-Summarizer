...
export type TestApiKeyRequest = Message<TestApiKeyPayload> & { type: 'testApiKey' };
export type SummarizeRequest = Message<SummarizePayload> & { type: 'summarize' };
...
export type ApiRequestPayload = OpenAIRequest | AnthropicRequest | GeminiRequest;
